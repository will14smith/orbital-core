...
namespace Orbital.Models
{
    public class Round
    {
        public Round(Guid id, Round round)
            : this(
            id: id,
        ...
        public Round(Guid id, Guid? variantOfId, string category, string name, bool indoor, IReadOnlyCollection<RoundTarget> targets)
        {
            Id = id;
